...
**Hello Rails Front End** is a react-redux app that fetches and displays a random greeting from a rails API endpoint.
...
```sh
  git clone https://github.com/boo-shehab/hello-react-front-end.git
```
